 ...
 * Use the {@link BerandaFragment2#newInstance} factory method to
...
public class BerandaFragment2 extends Fragment {
     ...
     * @return A new instance of fragment BerandaFragment2.
     */
    // TODO: Rename and change types and number of parameters
    public static BerandaFragment2 newInstance(String param1, String param2) {
        BerandaFragment2 fragment = new BerandaFragment2();
    ...
    CardView pesanan,addpesanan,addpelanggan,pengriman,adddriver;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        adddriver = view.findViewById(R.id.sec_newdriver);
        ...
        adddriver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                getActivity().finish();
                startActivity(new Intent(getActivity(), TambahDriver.class));
            }
        });
        return view;
    }
